...
android {
    namespace = "com.edumilestone.app"  // Application namespace: This is the package name of the application, used to uniquely identify the app.
    compileSdk = 35                       // Compile SDK version: Specifies the API level that the app will be compiled against (API level 35).

    defaultConfig {
        applicationId = "com.edumilestone.app"  // Application ID: Unique identifier for the app, used to distinguish the app on the Google Play Store and in the system.
