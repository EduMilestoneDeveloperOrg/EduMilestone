...
android {
    namespace = "com.edumilestone.centralcore" // ✅ Unique package namespace for Central Core module: The package name of the library, used to uniquely identify this module.
